...
//Stack size required to run the DHCPv6 relay agent
   ...
   #error DHCPV6_RELAY_STACK_SIZE parameter is invalid
#endif
...
//Priority at which the DHCPv6 relay agent should run
   ...
   #error DHCPV6_RELAY_PRIORITY parameter is invalid
#endif
...
//Maximum number of client-facing interfaces
   ...
   #error DHCPV6_RELAY_MAX_CLIENT_IF parameter is invalid
#endif
