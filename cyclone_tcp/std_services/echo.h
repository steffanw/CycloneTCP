...
//Stack size required to run the echo service
   ...
   #error ECHO_SERVICE_STACK_SIZE parameter is invalid
#endif
...
//Priority at which the echo service should run
   ...
   #error ECHO_SERVICE_PRIORITY parameter is invalid
#endif
...
//Size of the buffer for input/output operations
   ...
   #error ECHO_BUFFER_SIZE parameter is invalid
#endif
...
#elif (ECHO_TIMEOUT < 1)
   #error ECHO_TIMEOUT parameter is invalid
#endif
