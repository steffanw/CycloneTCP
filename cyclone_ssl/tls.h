...
//Enable SSL/TLS support
   ...
   #error TLS_SUPPORT parameter is invalid
#endif
...
//Client mode of operation
   ...
   #error TLS_CLIENT_SUPPORT parameter is invalid
#endif
...
//Server mode of operation
   ...
   #error TLS_SERVER_SUPPORT parameter is invalid
#endif
...
//Minimum version that can be negotiated
   ...
   #error TLS_MIN_VERSION parameter is invalid
#endif
...
//Maximum version that can be negotiated
   ...
   #error TLS_MAX_VERSION parameter is invalid
#endif
...
//Use BSD socket API
   ...
   #error TLS_BSD_SOCKET_SUPPORT parameter is invalid
#endif
...
//Session resumption mechanism
   ...
   #error TLS_SESSION_RESUME_SUPPORT parameter is invalid
#endif
...
//Lifetime of session cache entries
   ...
   #error TLS_SESSION_CACHE_LIFETIME parameter is invalid
#endif
...
//SNI (Server Name Indication) extension
   ...
   #error TLS_SNI_SUPPORT parameter is invalid
#endif
...
//Maximum number of certificates the end entity can load
   ...
   #error TLS_MAX_CERTIFICATES parameter is invalid
#endif
...
//Maximum message length that can be handled by the higher-level protocol
   ...
   #error TLS_MAX_PROTOCOL_DATA_LENGTH parameter is invalid
#endif
...
//RSA key exchange support
   ...
   #error TLS_RSA_SUPPORT parameter is invalid
#endif
...
//DHE_RSA key exchange support
   ...
   #error TLS_DHE_RSA_SUPPORT parameter is invalid
#endif
...
//DHE_DSS key exchange support
   ...
   #error TLS_DHE_DSS_SUPPORT parameter is invalid
#endif
...
//DH_ANON key exchange support
   ...
   #error TLS_DH_ANON_SUPPORT parameter is invalid
#endif
...
//RSA signature capability
   ...
   #error TLS_RSA_SIGN_SUPPORT parameter is invalid
#endif
...
//DSA signature capability
   ...
   #error TLS_DSA_SIGN_SUPPORT parameter is invalid
#endif
...
//Stream cipher support
   ...
   #error TLS_STREAM_CIPHER_SUPPORT parameter is invalid
#endif
...
//CBC block cipher support
   ...
   #error TLS_CBC_CIPHER_SUPPORT parameter is invalid
#endif
...
//CCM mode support
   ...
   #error TLS_CCM_CIPHER_SUPPORT parameter is invalid
#endif
...
//GCM mode support
   ...
   #error TLS_GCM_CIPHER_SUPPORT parameter is invalid
#endif
...
//RC4 cipher support
   ...
   #error TLS_RC4_SUPPORT parameter is invalid
#endif
...
//IDEA cipher support
   ...
   #error TLS_IDEA_SUPPORT parameter is invalid
#endif
...
//DES cipher support
   ...
   #error TLS_DES_SUPPORT parameter is invalid
#endif
...
//Triple DES cipher support
   ...
   #error TLS_3DES_SUPPORT parameter is invalid
#endif
...
//AES cipher support
   ...
   #error TLS_AES_SUPPORT parameter is invalid
#endif
...
//Camellia cipher support
   ...
   #error TLS_CAMELLIA_SUPPORT parameter is invalid
#endif
...
//SEED cipher support
   ...
   #error TLS_SEED_SUPPORT parameter is invalid
#endif
...
//ARIA cipher support
   ...
   #error TLS_ARIA_SUPPORT parameter is invalid
#endif
...
//MD5 hash support
   ...
   #error TLS_MD5_SUPPORT parameter is invalid
#endif
...
//SHA-1 hash support
   ...
   #error TLS_SHA1_SUPPORT parameter is invalid
#endif
...
//SHA-224 hash support
   ...
   #error TLS_SHA224_SUPPORT parameter is invalid
#endif
...
//SHA-256 hash support
   ...
   #error TLS_SHA256_SUPPORT parameter is invalid
#endif
...
//SHA-384 hash support
   ...
   #error TLS_SHA384_SUPPORT parameter is invalid
#endif
...
//SHA-512 hash support
   ...
   #error TLS_SHA512_SUPPORT parameter is invalid
#endif
...
typedef enum
{
   TLS_EC_CURVE_SECT163K1                = 1,
   TLS_EC_CURVE_SECT163R1                = 2,
   TLS_EC_CURVE_SECT163R2                = 3,
   TLS_EC_CURVE_SECT193R1                = 4,
   TLS_EC_CURVE_SECT193R2                = 5,
   TLS_EC_CURVE_SECT233K1                = 6,
   TLS_EC_CURVE_SECT233R1                = 7,
   TLS_EC_CURVE_SECT239K1                = 8,
   TLS_EC_CURVE_SECT283K1                = 9,
   TLS_EC_CURVE_SECT283R1                = 10,
   TLS_EC_CURVE_SECT409K1                = 11,
   TLS_EC_CURVE_SECT409R1                = 12,
   TLS_EC_CURVE_SECT571K1                = 13,
   TLS_EC_CURVE_SECT571R1                = 14,
   TLS_EC_CURVE_SECP160K1                = 15,
   TLS_EC_CURVE_SECP160R1                = 16,
   TLS_EC_CURVE_SECP160R2                = 17,
   TLS_EC_CURVE_SECP192K1                = 18,
   TLS_EC_CURVE_SECP192R1                = 19,
   TLS_EC_CURVE_SECP224K1                = 20,
   TLS_EC_CURVE_SECP224R1                = 21,
   TLS_EC_CURVE_SECP256K1                = 22,
   TLS_EC_CURVE_SECP256R1                = 23,
   TLS_EC_CURVE_SECP384R1                = 24,
   TLS_EC_CURVE_SECP521R1                = 25,
   TLS_EC_CURVE_ARBITRARY_EXPLICIT_PRIME = 65281,
   TLS_EC_CURVE_ARBITRARY_EXPLICIT_CHAR2 = 65282
} TlsEcNamedCurve;
...
typedef struct
{
   ...
   DhParameters dhParameters;               ///<Diffie-Hellman parameters
   ...
   TlsCertificateType peerCertType;         ///<Peer certificate type
   RsaPublicKey peerRsaPublicKey;           ///<Peer RSA public key
   DsaPublicKey peerDsaPublicKey;           ///<Peer DSA public key
