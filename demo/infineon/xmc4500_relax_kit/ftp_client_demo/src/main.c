...
int_t main(void)
{
   ...
   interface->nicDriver = &xmc4500EthDriver;
   interface->phyDriver = &ksz8031PhyDriver;
   //Interface name
   strcpy(interface->name, "eth0");
   //Set host MAC address
   macStringToAddr("00-AB-CD-EF-45-00", &interface->macAddr);

#if (IPV6_SUPPORT == ENABLED)
   //Set link-local IPv6 address
   ipv6StringToAddr("fe80::00ab:cdef:4500", &interface->ipv6Config.linkLocalAddr);
#endif
